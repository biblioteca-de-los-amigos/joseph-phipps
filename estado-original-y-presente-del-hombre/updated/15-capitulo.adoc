...
que el evangelio vino tanto en palabra como en poder; pero no en palabras _solamente,_
...
es _para salvar_ a los que le esperan con ese fin.
...
'`__en los que__ se pierden está encubierto;`' griego '`__en tois__`'];
...
"`el reino de Dios está __entre__ vosotros.`"
...
"`ἐντός,`" que claramente significa _dentro_ o _adentro_, y no "`εν`"
que puede ser interpretado como _en_ o _en medio._
